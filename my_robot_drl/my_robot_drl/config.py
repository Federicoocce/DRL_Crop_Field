...
class GlobalConfig:
    ...
    # --- NEW BEV SCALING PARAMETERS FOR YOUR ROBOT ---
    # These values define the physical size of the BEV grid.
    # Based on your 2.0m LiDAR range, we'll create a 4m x 4m grid.
...
# Create a default instance of the class that other scripts can import.
# ===================================================================
config = GlobalConfig()